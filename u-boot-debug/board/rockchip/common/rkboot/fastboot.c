...
void board_fbt_preboot(void)
{
	...
	if (gd->fdt_blob) {
		...
		printf("$$$$$$$$$^^^^^^^^^3 gd->fdt_blob:%d\n",gd->fdt_blob);
			...
			printf("$$$$$$$$$$$$$$$$$$$$$$6 rockchip_display_init:%x:%d\n",rockchip_display_init,g_logo_on_state);
			g_logo_on_state = 1;
		}
		printf("$$$$$$$$$$$$$$$$$$$$$$5 rockchip_display_init:%x:%d\n",rockchip_display_init,g_logo_on_state);
#endif	
	}
