...
void rk3399_led(void)
{
	gpio_direction_output(GPIO_BANK2 | GPIO_D3, 0);
	gpio_direction_output(GPIO_BANK0 | GPIO_B5, 1);
}

void rk3399_leds(int val)
{
	gpio_direction_output(GPIO_BANK2 | GPIO_D3, val);
	gpio_direction_output(GPIO_BANK0 | GPIO_B5, val);
}
