...
static int LM36923_I2C_probe(u32 bus, u32 addr)
{
	char val;
	int ret;
	i2c_set_bus_num(bus);
...
void LM36923_Init()	
{
	...
	i2c_reg_write(LM36923_I2C_ADDR, BL_REG_RESET, 0x01);
	mdelay(10);
	i2c_reg_write(LM36923_I2C_ADDR, BL_REG_DEVEICE_ON, 0x01);
		temp = i2c_reg_read(LM36923_I2C_ADDR, BL_REG_DEVEICE_ON);
	...
	temp = i2c_reg_read(LM36923_I2C_ADDR, 0x13);
	i2c_reg_write(LM36923_I2C_ADDR, 0x13, temp | (0x01<<4));
	temp = i2c_reg_read(LM36923_I2C_ADDR, 0x13);
	printf("REG_13 = 0x%x\r\n",temp);
	i2c_reg_write(LM36923_I2C_ADDR, BL_REG_DEVEICE_ON, 0x03);
	mdelay(10);
	i2c_reg_write(LM36923_I2C_ADDR, BL_REG_DEVEICE_ON, 0x07);
	mdelay(10);
...
int LM36923_mInit(u32 val)	
{
	...
	i2c_reg_write(LM36923_I2C_ADDR, BL_REG_DEVEICE_ON, 0x0f);
	mdelay(10);
		temp = i2c_reg_read(LM36923_I2C_ADDR, BL_REG_RESET);
	printf("BL_REG_RESET = 0x%x\r\n",temp);
		temp = i2c_reg_read(LM36923_I2C_ADDR, BL_REG_MODE);
	printf("BL_REG_MODE = 0x%x\r\n",temp);
		temp = i2c_reg_read(LM36923_I2C_ADDR, BL_REG_DEVEICE_ON);
	printf("BL_REG_DEVEICE_ON = 0x%x\r\n",temp);
