...
static int rockchip_vop_init(struct display_state *state)
{
	...
	printf("vop reg :0x%x,0x%x,0x%x,0x%x,0x%x,0x%x\n",(int)vop->regs,(int)vop->regsbak,(int)vop->win,(int)vop->win_offset,(int)vop->ctrl,(int)vop->version);
